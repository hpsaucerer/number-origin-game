...
export default function WelcomeModal({ open, onOpenChange, showTutorial, setShowTutorial }) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      {/* Make sure overlay fully covers all other UI */}
      <DialogOverlay className="fixed inset-0 bg-white/90 backdrop-blur-md z-[100]" />
      
      <DialogContent
        className="mx-auto rounded-xl shadow-xl bg-white z-[110]"
